...
/// }
/// ```
pub fn canonicalize<P: AsRef<std::path::Path>>(path: P) -> io::Result<std::path::PathBuf> {
...
/// }
/// ```
pub fn create_dir<P: AsRef<std::path::Path>>(path: P) -> io::Result<()> {
...
/// }
/// ```
pub fn create_dir_all<P: AsRef<std::path::Path>>(path: P) -> io::Result<()> {
...
pub fn exists<P: AsRef<std::path::Path>>(path: P) -> io::Result<bool> {
	std::fs::exists(path)
}
...
/// }
/// ```
pub fn metadata<P: AsRef<std::path::Path>>(path: P) -> io::Result<Metadata> {
...
/// }
/// ```
pub fn read<P: AsRef<std::path::Path>>(path: P) -> io::Result<Vec<u8>> {
	std::fs::read(path)
}
...
/// }
/// ```
pub fn read_dir<P: AsRef<std::path::Path>>(path: P) -> io::Result<ReadDir> {
...
/// }
/// ```
pub fn read_link<P: AsRef<std::path::Path>>(path: P) -> io::Result<std::path::PathBuf> {
...
/// }
/// ```
pub fn read_to_string<P: AsRef<std::path::Path>>(path: P) -> io::Result<String> {
...
/// }
/// ```
pub fn remove_dir<P: AsRef<std::path::Path>>(path: P) -> io::Result<()> {
...
/// }
/// ```
pub fn remove_dir_all<P: AsRef<std::path::Path>>(path: P) -> io::Result<()> {
...
/// }
/// ```
pub fn remove_file<P: AsRef<std::path::Path>>(path: P) -> io::Result<()> {
...
/// }
/// ```
pub fn set_permissions<P: AsRef<std::path::Path>>(path: P, perm: Permissions) -> io::Result<()> {
...
/// }
/// ```
pub fn symlink_metadata<P: AsRef<std::path::Path>>(path: P) -> io::Result<Metadata> {
...
/// }
/// ```
pub fn write<P: AsRef<std::path::Path>, C: AsRef<[u8]>>(path: P, contents: C) -> io::Result<()> {
